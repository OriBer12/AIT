...
export default class Node extends React.Component {
  ...
  renderNodeElement = nodeStyle => {
    const { circleRadius, nodeSvgShape, nodeData} = this.props;
    ...
    return nodeSvgShape.shape === 'none'
      ? null
      : <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" width="100" height="100" x="-15" y="-15">
  <linearGradient id="lg" x1="1" y1="0.5" x2="0" y2="0.5">
      <stop offset="0%" stop-opacity="1" stop-color="red"/>
      <stop offset={100 - nodeData.progress+"%"} stop-opacity="1" stop-color="red"/>
      <stop offset={100 - nodeData.progress+"%"} stop-opacity="1" stop-color="green"/>
      <stop offset="100%" stop-opacity="1" stop-color="green"/>
  </linearGradient>
  <circle cx="15" cy="15" r="15" fill="url(#lg)" stroke="white" stroke-width="5"/>
</svg>
